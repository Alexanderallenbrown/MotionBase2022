...
theta_angle=(pi/3-theta_p)/2, theta_r = radians(8),
      ...
      re[3][6] = {
          {
            RD*cos(radians(7.3)),RD*cos(radians(112.7)),RD*cos(radians(127.3)),RD*cos(radians(232.7)),RD*cos(radians(247.4)),RD*cos(radians(352.7))
         },
         {
            RD*sin(radians(7.3)),RD*sin(radians(112.7)),RD*sin(radians(127.3)),RD*sin(radians(232.7)),RD*sin(radians(247.3)),RD*sin(radians(352.7))
         },
         {
              0,0,0,0,0,0
          }
